...
class TestReviewerTagDisplay:
    ...
    def test_codex_reviewer_shows_yellow_tag(self):
        """[codex-gpt5] → [Codex] in yellow in event header."""
        events = [
            {
                "event_type": "CC",
                "project_name": "myproj",
                "session_id": "s1",
                "feedback_text": "[codex-gpt5] Some code review feedback",
                "timestamp": time.time(),
            }
        ]
    ...
    def test_sdk_reviewer_shows_green_tag(self):
        """[anthropic-sdk] → [SDK] in green in event header."""
        events = [
            {
                "event_type": "IV",
                "project_name": "myproj",
                "session_id": "s1",
                "feedback_text": "[anthropic-sdk] Intent validation failed",
                "timestamp": time.time(),
            }
        ]
        rendered = _render_event_feed(events)
    ...
    def test_gemini_reviewer_shows_cyan_tag(self):
        """[gem-flash] → [Gem] in cyan in event header."""
        events = [
            {
                "event_type": "CC",
                "project_name": "myproj",
                "session_id": "s1",
                "feedback_text": "[gem-flash] Clean code violation",
                "timestamp": time.time(),
            }
        ]
        rendered = _render_event_feed(events)
    ...
    def test_unknown_reviewer_leaves_feedback_unchanged(self):
        """[unknown-thing] is not recognized — raw tag preserved."""
        events = [
            {
                "event_type": "IV",
                "project_name": "myproj",
                "session_id": "s1",
                "feedback_text": "[unknown-thing] Some feedback",
                "timestamp": time.time(),
            }
        ]
        rendered = _render_event_feed(events)
        assert "Some feedback" in rendered
        assert "[unknown-thing]" in rendered
        assert "[Codex]" not in rendered
        assert "[SDK]" not in rendered
        assert "[Gem]" not in rendered
        ...
        events = [
            {
                ...
                "project_name": "myproj",
                "session_id": "s1",
                "feedback_text": "[codex-gpt5] Actual feedback here",
                "timestamp": time.time(),
            }
        ]
        rendered = _render_event_feed(events)
